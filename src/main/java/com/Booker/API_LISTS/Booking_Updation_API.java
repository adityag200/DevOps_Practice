...
public class Booking_Updation_API {

	static ExcelReader er = new ExcelReader("./testdata/TestData.xlsx");
	static int updatedBookingID;
	
	//Function to update booking through PUT API
	public static void update_booking(Hashtable<String, String> data, ITestContext context, String sheetname)
	{
		RequestSpecification request = RestAssured.given();
		Create_Booking_JSON update_booking = new Create_Booking_JSON();
		String reqBody = update_booking.booking_creation(data, context);
		...
		Response response = request.log().all().put(data.get("endpoint"));
